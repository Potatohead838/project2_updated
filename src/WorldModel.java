...
public final class WorldModel
{
            ...
            String[] properties, WorldModel world, ImageStore imageStore)
    {
        if (properties.length == SAPLING_NUM_PROPERTIES) {
            ...
            ExecutableEntity entity = new Sapling(id, pt, imageStore.getImageList(imageStore, SAPLING_KEY), health);
            ...
            String[] properties, WorldModel world, ImageStore imageStore)
    {
        if (properties.length == DUDE_NUM_PROPERTIES) {
            ...
            ExecutableEntity entity = new DudeNotFull(properties[DUDE_ID],
                    pt,
            ...
            String[] properties, WorldModel world, ImageStore imageStore)
    {
        if (properties.length == FAIRY_NUM_PROPERTIES) {
            ...
            ExecutableEntity entity = new Fairy(properties[FAIRY_ID],
                    pt,
    ...
    public Optional<Entity> findNearest(
            Point pos, List<Class> kind)
    {
        List<Entity> ofType = new LinkedList<>();

        for (Entity entity:this.entities) {
            if(kind.indexOf(entity.getClass()) != -1){
                ofType.add(entity);
            }
        }
