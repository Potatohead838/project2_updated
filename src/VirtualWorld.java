    ...
    */
    ...
    public void mousePressed() {
        ...
        if (entityOptional.isPresent())
        {
            ...
            if (entity instanceof EntityHasHealth){
                System.out.println(entity.getId() + ": " + entity.getClass() + " : " + ((EntityHasHealth) entity).getHealth());
            }
            else {
            ...
            WorldModel world, EventScheduler scheduler, ImageStore imageStore)
    {
        for (Entity entity : world.entities) {
            scheduler.scheduleActions((AnimationEntity) entity, scheduler, world, imageStore);
        }
    }
